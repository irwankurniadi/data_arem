<?php
// open form
echo form_open(site_url('project/tambah'));
?>

<div class="form-group row">
  <label for="kode_project" class="col-sm-3 col-form-label">Kode Project</label>
  <div class="col-sm-9">
    <input type="text" name="kode_project" class="form-control" placeholder="Kode Project" value="<?php echo set_value('kode_project') ?>" required>
  </div>
</div>
...
<div class="form-group row">
  ...
  <div class="col-sm-9">
    <input type="text" name="nama_project" class="form-control" placeholder="Nama Project" value="<?php echo set_value('nama_project') ?>" required>
  </div>
</div>
...
<div class="form-group row">
  ...
  <div class="col-sm-9">
   	...
   	<button type="submit" name=submit class="btn btn-success btn-lg">
                <i class="fa fa-save"></i> Simpan Data Project
     </button>
     <a href="<?php echo site_url('project') ?>" class="btn btn-info btn_lg">
