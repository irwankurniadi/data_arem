<p>
	...
	<a href="<?php echo site_url('gore_analysis/cetak_agent_behavior') ?>" target="_blank" class="btn btn-success">
        <i class = "fa fa-print"></i> Cetak
	</a>
	<a href ="<?php echo site_url('gore_analysis/export_data_agent_behavior') ?>" class = "btn btn-primary" target="_blank">
