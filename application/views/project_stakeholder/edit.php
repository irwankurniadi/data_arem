...
<?php echo form_open(site_url('project_stakeholder/edit/'.$project_stakeholder->id)) ?>
  ...
  <div class="col-sm-9">
    <select name="project_id" class="form-control select2" required>
      ...
      <?php foreach ($project as $project) { ?>
        <option value="<?php echo $project->project_id ?>"<?php if($project->project_id==$project_stakeholder->project_id) { echo 'selected'; } ?>>
  ...
  <div class="col-sm-9">
    <select name="stakeholder_id" class="form-control select2" required>
      ...
      <?php foreach ($stakeholder as $stakeholder) { ?>
        <option value="<?php echo $stakeholder->stakeholder_id ?>"<?php if($stakeholder->stakeholder_id==$project_stakeholder->stakeholder_id) { echo 'selected'; } ?>>
...
<div class="form-group row">
  ...
  <div class="col-sm-9">
    <select name="stakeholder_role" class="form control">
      ...
      <option value="User" <?php if($project_stakeholder ->stakeholder_role=='User') {echo 'selected';} ?>>User</option>
    </select>
  </div>
</div>
