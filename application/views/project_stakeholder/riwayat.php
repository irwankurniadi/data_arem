<p class="text-right">
	<a href ="<?php echo site_url('project_stakeholder/riwayat/' .$pasien->id_pasien) ?>" target="_blank" class = "btn btn-success">
		<i class="fa fa-print"></i> Cetak Riwayat Suhu Tubuh
	</a>

	<a href ="<?php echo site_url('project_stakeholder/export/' .$pasien->id_pasien) ?>" class = "btn btn-primary" target="_blank">
